...
<html class="no-js" lang="zxx">
 <head>
  ...
  <title>Zocker - eSports and Gaming HTML Template - Blog</title>
   ...
   <div class="container">
    <div class="row">
     <div class="col-lg-8">
      ...
      <div class="vs-blog">
       <div class="blog-meta bg-smoke has-border">
        <a href="#"><i class="fal fa-calendar-alt"></i>July 29, 2021</a> 
        <a href="#"><i class="far fa-comments"></i>263</a>
        <div class="cat-list">
         <i class="far fa-folder-open"></i> 
         <a href="#">e-sports</a> 
      ...
      <div class="vs-blog">
       ...
       <div class="blog-meta bg-smoke has-border">
        <a href="#"><i class="fal fa-calendar-alt"></i>June 15, 2021</a> 
        <a href="#"><i class="far fa-comments"></i>263</a>
        <div class="cat-list">
         <i class="far fa-folder-open"></i> 
         <a href="#">e-sports</a> 
