   ...
   <div class="container position-relative">
    <div class="row align-items-center">
     <div class="col-5 col-md-3">
      <div class="logo">
       <a href="javaScript:void(0)"><img src="@/assets/img/logo-2.png" alt="Zocker" /></a>
      </div>
     </div>
      ...
      <nav class="main-menu menu-sticky1 d-none d-lg-block link-inherit">
       <ul>
        ...
        <li class="mega-menu-wrap menu-item-has-children"><a href="#">Pages</a>
         <ul class="mega-menu">
          <li><a href="javaScript:void(0)">Pagelist 1</a>
           <ul>
            <li><a href="javaScript:void(0)">Home One</a></li>
...
<!--       <a href="javaScript:void(0)"><img src="${sessionScope.user.img}" alt="Zocker"/></a>-->
      <a>userimg</a>
            <p class="text-light mt-3">Your Name</p>
     ...
     <div class="my-40">
      ...
      <div class="info-style1">
       <p class="fs-4 lh-1 fw-medium text-white mb-0"><a href="javaScript:void(0)">注销</a></p>
      </div>
     </div>
    </div>
    <h3 class="sidebox-title text-white h5"><a href="javaScript:void(0)"><img src="@/assets/img/lolImg/gwc.jpg" style="height: 60px" width="60px">Your shopping cart</a></h3>
  ...
  <div class="vs-menu-wrapper">
   <div class="vs-menu-area bg-dark">
    ...
    <div class="mobile-logo">
     <a href="javaScript:void(0)"><img src="@/assets/img/lolImg/LoLlog.png" alt="Zocker" /></a>
    </div>
   ...
   <div class="container z-index-common">
    <div class="breadcumb-content text-center">
     ...
     <ul class="breadcumb-menu-style1 text-white mx-auto fs-xs">
      <li><a href="javaScript:void(0)"><i class="fal fa-home"></i>Home</a></li>
  ...
  <section class="vs-team-wrapper vs-team-layout1 space-top newsletter-pb">
   <div class="container">
    <div class="row justify-content-center">
      <div class="col-xl-3 col-lg-4 col-sm-6" v-for="(team,index) in list">
       <div class="vs-team bg-fluid" data-bg-src="assets/img/shape/member-bg-1.png">
        <div class="team-img mb-35">
         <a href="javaScript:void(0)"><img src="@/assets/img/lolImg/IG.png" @click="showDetails(team.tid)" alt="Team Image" /></a>
        </div>
        <h3 class="team-name h5 text-white mb-0"><a href="javaScript:void(0)">{{team.tname}}</a></h3>
        <span class="team-degi text-light-white fs-xs">merber Number {{team.merbernumber}}</span>
       </div>
      </div>
     </div>
    </div>
...
import {getTeams} from "@/js/api/team/teams";
...
export  default {
  ...
  methods:{
    loadTeams(){
     getTeams(this.pageNo,this.pageSize)
          .then((resp)=>{
 ...
 // function  find2(pageNo){
 //  window.location.href="teamController/page?pageNo="+pageNo;
 // }
</script>