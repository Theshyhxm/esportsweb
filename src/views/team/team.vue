...
<html class="no-js" lang="zxx">
 <head>
  ...
  <title>Zocker - eSports and Gaming HTML Template - Teams</title>
      ...
      <div class="col-xl-3 col-lg-4 col-sm-6">
       <div class="vs-team bg-fluid" data-bg-src="assets/img/shape/member-bg-1.png">
        <div class="team-img mb-35">
         <a href="teamController/findTeamById?tid=${team.tid}"><img src="${team.teamimg}" alt="Team Image" /></a>
        </div>
        <h3 class="team-name h5 text-white mb-0"><a href="teamController/findTeamById?tid=${team.tid}">${team.tname}</a></h3>
